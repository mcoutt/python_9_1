...
def show_fields():
    ...
    for line in game_field:
        ...
        # field_l = []  # Это левая строка с крестиками и ноликами
        # field_r = []  # Это правая строка с цифрами для удобства
        # for i in line:
        #     if isinstance(i, int):
        #         field_l.append(' ')
        #         field_r.append(str(i))
        #     else:
        #         field_l.append(i)
        #         field_r.append(' ')
        # field_l = " | ".join(field_l)
        # field_r = " | ".join(field_r)
        result = [line[:], line[:]]
